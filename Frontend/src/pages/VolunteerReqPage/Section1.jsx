...
const SOSRequestsPage = () => {
  ...
  const [activeTab, setActiveTab] = useState("volunteer"); // "volunteer" or "accepted"
  ...
  const getFilteredRequests = () => {
    ...
    if (activeTab === "volunteer") {
      // Show volunteer requests that are not accepted
      filteredRequests = sosRequests.filter(
        (request) => request.requestType === "volunteer" && !request.acceptedBy
      );
      ...
      <header className="bg-white shadow">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="text-gray-600">
            <span className="font-medium">{user?.name || "Volunteer"}</span>
          </div>
        </div>
      </header>
        ...
        {loadingLocations ? (
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <h3 className="text-xl font-medium text-gray-800 mt-4">
              No {activeTab === "volunteer" ? "Volunteer" : "Accepted"} Requests
              Available
            </h3>
            <p className="text-gray-600 mt-2">
              {activeTab === "volunteer"
                ? "There are currently no volunteer requests within 100km of your location."
